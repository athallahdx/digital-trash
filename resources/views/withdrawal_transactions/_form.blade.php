    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
        <div>
            <label for="transaction_number" class="block text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
                Nomor Transaksi <span class="text-rose-500">*</span>
            </label>
            <input id="transaction_number" name="transaction_number" type="text" value="{{ old('transaction_number', $transaction->transaction_number ?? '') }}" required
        ...
        <div>
            <label for="amount" class="block text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
            ...
            <div class="relative mt-1.5">
                ...
                <input id="amount" name="amount" type="number" step="0.01" value="{{ old('amount', $transaction->amount ?? '') }}" required
